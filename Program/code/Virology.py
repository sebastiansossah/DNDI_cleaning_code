...
def virology(df_root, path_excel_writer, lista_instancias_abiertas):
    '''
    ...
    virology_output = virology_output[~virology_output['Form Field Instance ID'].isin(lista_instancias_abiertas)]
