...
def mRNA_markers(df_root, path_excel_writer, lista_instancias_abiertas):
    '''
    ...
    mRNA_markers_output = mRNA_markers_output[~mRNA_markers_output['Form Field Instance ID'].isin(lista_instancias_abiertas)]
