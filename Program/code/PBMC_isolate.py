...
def PBMC_isolate(df_root, path_excel_writer, lista_instancias_abiertas):
    '''
    ...
    PBMC_isolate_output = PBMC_isolate_output[~PBMC_isolate_output['Form Field Instance ID'].isin(lista_instancias_abiertas)]
