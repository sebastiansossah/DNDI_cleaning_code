...
def interleukin_6(df_root, path_excel_writer, lista_instancias_abiertas):
    '''
    ...
    interleukin_6_output = interleukin_6_output[~interleukin_6_output['Form Field Instance ID'].isin(lista_instancias_abiertas)]
