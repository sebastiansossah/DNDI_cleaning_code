...
def prior_concomitant_medication(df_root, path_excel_writer, lista_instancias_abiertas):
    ...
    df_informed = df_informed[['Participante','Valor']].drop_duplicates()
    ...
    df_adverse = df_adverse[['Participante', 'to_join' ,'Valor']].drop_duplicates()
    ...
    df_adverse_start = df_adverse_start[['Participante', 'to_join_start' ,'Valor']].drop_duplicates()
    ...
    df_adverse_end = df_adverse_end[['Participante', 'to_join_end' ,'Valor']].drop_duplicates()
    ...
    df_adverse_aditional = df_adverse_aditional[['Participante', 'to_join_adverse_aditional' ,'Valor']].drop_duplicates()
    ...
    df_end_study_general = df_end_study_general[['Participante', 'Valor']].drop_duplicates()
