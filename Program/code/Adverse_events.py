...
def adverse_events(df_root, path_excel_writer, lista_instancias_abiertas):
    '''
        ...
        for subdataset in subdatasets:
            ...
            for index, row in pru.iterrows():
                ...
                if status != '':
                    ...
                    # Revision AE0130
                    if str(date_dosing_miltefosine) == 'nan':
                        pass
                    else:
                        try:
                            #print(start_date_pure, f'"{date_dosing_miltefosine}"')
    ...
    adverse_events_output = adverse_events_output[~adverse_events_output['Form Field Instance ID'].isin(lista_instancias_abiertas)]
