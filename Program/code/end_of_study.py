...
def end_of_study(df_root, path_excel_writer, lista_instancias_abiertas):
    '''
    ...
    end_of_study_output = end_of_study_output[~end_of_study_output['Form Field Instance ID'].isin(lista_instancias_abiertas)]
