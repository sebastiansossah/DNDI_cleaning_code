...
def urine_microscopic_examination(df_root, path_excel_writer, lista_instancias_abiertas):
    '''
    ...
    urine_microscopic_examination_output = urine_microscopic_examination_output[~urine_microscopic_examination_output['Form Field Instance ID'].isin(lista_instancias_abiertas)]
